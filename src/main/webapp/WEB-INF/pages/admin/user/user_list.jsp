        ...
        <form class="form-horizontal" id="myserchform" name="myform" action="<%=basePath%>admin/searchUser" method="post">
            <div class="form-group">
                <div  class="col-sm-8" style="text-align:center;">
                    ...
                    <input type="text" name="username" value="${searchuser.username}"/>
                    <span >wechat：</span>
                    <input type="text" name="wechat" value="${searchuser.wechat}"/>
                </div>
                <div class="col-sm-4">
                    <button class="btn btn-success btn-sm" type="submit" >查找</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="height:300px; ">
                <form class="form-horizontal" id="myviewform" name="myform">
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 control-label" >wechat:</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="my_wechat" name="wechat" readonly style="margin-top: 8px;"/>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-body" style="height:300px; ">
                <form class="form-horizontal" id="myeditform" name="myform">
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 control-label" >wechat:</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="my_wechat" name="wechat" style="margin-top: 8px;"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-4 control-label" >创建时间:</label>
        ...
        $.ajax({
            ...
            success:function(json){
                if(json){
                    ...
                    $('#myviewform').find("input[name='wechat']").val(json.wechat);
        ...
        $.ajax({
            ...
            success:function(json){
                if(json){
                    ...
                    $('#myeditform').find("input[name='wechat']").val(json.wechat);
