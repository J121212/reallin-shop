    ...
    <nav class="white nav1">
        <div class="nav-wrapper">
            <a href="<%=basePath%>goods/homeGoods" class="logo">
                <em class="em1">reallin</em>
                <em class="em2">shop</em>
            ...
            <ul class="slides" style="height: 400px;">
                <li class="active" style="opacity: 1;">
                    <a href="<%=basePath%>goods/homeGoods">
                        <div class="bannerimg">
                            <ul class="bannerul">
                                <p class="text1">欢迎来到我的商店</p>
                                <p class="text2">WELCOME TO MY SHOP</p>
                                <p class="text3">Bienvenue dans mon magasin</p>
                                <p class="text4">내 상점에 오신 걸 환영합니다</p>
                                <p class="text5"> مرحبا بكم في متجري</p>
                                <p class="text6">Witamy w moim sklepie</p>
                            </ul>
                          <!--   <div class="logoimg">
